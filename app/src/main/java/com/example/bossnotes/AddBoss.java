...
public class AddBoss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_boss);
    ...
    public void kayitol(View v){
        try{
            ...
            String result= helper.AddBoss(name, email, password, number,gender, birth);
    ...
    public void Delete(View v){
        try{
            ...
            String result= helper.DeleteBoss(id);
            Toast.makeText(this, result, Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    public void update(View v){
        try{
            ...
            String gender= genderr;
            String idd= editTextId.getText().toString(); int id=Integer.parseInt(idd);
            String result= helper.UpdateBoss(id, name, email, password, number, gender, birth);
            Toast.makeText(this, result, Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
